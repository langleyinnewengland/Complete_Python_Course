#argument - value you pass intoa function
#parameter - variable that accepts values inside a function
...
#car to calculate is the parameter
def calculate_mpg(car_to_calculate):  
    # This can be renamed to `car`
    mpg = car_to_calculate["mileage"] / car_to_calculate["fuel_consumed"]
    name = f"{car_to_calculate['make']} {car_to_calculate['model']}"
    print(f"{name} does {mpg} miles per gallon.")


#when calling the function, put the argument in the parens
#The value you pass into a parameter is an argument
...
#calculate the mpg for the first car in list
